            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        {{-- added utk kelas --}}
                        <div class="form-group row">
                            <label for="student_no" class="col-md-4 col-form-label text-md-right">{{ __('No Pelajar') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="course_id" class="col-md-4 col-form-label text-md-right">{{ __('Program') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Sah Katalaluan') }}</label>
